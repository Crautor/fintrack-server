module.exports = {
  conta_a_vencer: (data) => {
    ...
    return {
      ...
      message: `Sua conta de ${data.tipoConta} no valor de R$ ${data.valor.toFixed(
        2,
      )} vence em ${diasParaVencimento} dia(s) (${dataFormatada}).`,
    };
  },
  ...
  meta_atingida: (data) => {
    return {
      ...
      message: `Você atingiu sua meta de ${data.nomeMeta} com o valor de R$ ${data.valorAtual.toFixed(
        2,
      )}. Continue assim!`,
    };
  },
